...
from .models import OrderItem, Order, Transaction, Profile
...
def add_to_cart(request, **kwargs):
    ...
    return redirect(reverse('users:product-list'))
...
def delete_from_cart(request, item_id):
    ...
    return redirect(reverse('users:order_summary'))
...
def checkout(request):
    return render(request, 'blog/site4.html')
...
#                 return redirect(reverse('users:update_records',
#                         kwargs={
#                             'token': token
#                         })
#                     )
...
#                 return redirect(reverse('users:checkout'))
